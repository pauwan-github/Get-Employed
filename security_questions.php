...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "SELECT * FROM users WHERE email = '$email' AND firstName = '$firstName' AND lastName = '$lastName' AND yearOfBirth = '$yearOfBirth' AND phone = '$phone'";
...
<h2>Security Questions</h2>
    <form method="post">
        <p>Enter your correct details as per your registration information</p>
        <input type="text" name="firstName" id="firstName" placeholder="First Name" required>
        <input type="text" name="lastName" id="lastName" placeholder="Last Name" required>
        <input type="number" name="yob" id="yob" placeholder="Year of Birth" required>
